	...
	<div class="FooterMenu">
		<ul>
			...
			<li class="Facebook"><a
				...
				title="페이스북"><img	src="../../Images/Ver1/Common/facebook.png" /></a></li>
			<li class="Instagram"><a
				href="https://www.instagram.com/SangSangMKT/"
				target="_blank" title="인스타그램"><img src="../../Images/Ver1/Common/instagram.png" /></a></li>
			<li class="Youtube"><a
				href="https://www.youtube.com/"
				target="_blank" title="유튜브"><img src="../../Images/Ver1/Common/youtube.png" /></a></li>
		</ul>
		<div class="clear"></div>
	</div>
	<div class="FooterInfo">
		<ul>
			<li	class="CallCenter"><a href="/Home/Cscenter/NoticeList.asp"><b class="string">TEAM2 문의전화</b> <b
			...
			<img src="../../Images/Ver1/Common/footer_btn1.png" />자주하는 질문</a>
			<a href="#">
			<img src="../../Images/Ver1/Common/footer_btn2.png"  />1:1 문의/상담</a></li>
