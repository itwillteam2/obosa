...
<% request.setCharacterEncoding("utf-8"); %>   
	...
	<link rel="stylesheet" type="text/css" href="${contextPath}/Css/Common/Common.css" />
	<link rel="stylesheet" type="text/css" href="${contextPath}/Css/Common/swiper.min.css" />
	...
	<link rel="stylesheet" type="text/css" href="${contextPath}/Css/Common/Index.css" />
	<link rel="stylesheet" type="text/css" href="${contextPath}/Css/Common/FlexSliderIndex.css" />
	<script type="text/javascript" src="/Home/Js/Common/jquery.flexslider-min.js" charset="utf-8"></script> 
	<link rel="stylesheet" type="text/css" href="${contextPath}/Css/Common/swiper.min.css" />
	<link rel="stylesheet" type="text/css" href="${contextPath}/Css/Member/Member.css" />
	<link rel="stylesheet" type="text/css" href="${contextPath}/Css/Common/Item.css" />
	...
	<script type="text/javascript" src="/Home/Js/Common/jquery.bxslider.ABIndex.js"></script>
