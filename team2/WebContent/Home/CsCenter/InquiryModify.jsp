			...
			<div class="outter_box">
				<div class="left_box">
					...
					<div>
						<ul>
							<li>*이메일</li>
							<li><input type="text" name="email" id="email" value="${inquiry.email}"/></li>
						</ul>
					</div>
					...
					<div>
						<ul>
							<li>*문의분야</li>
							<li>
								<select id="category" name="category" title="상담유형 선택">
								<c:choose>
									<c:when test="${inquiry.category == 'order'}">
										<option value="">상담유형 선택</option>
										<option value="order" selected>주문/결제</option>
										<option value="delivery">배송</option>
										<option value="cancel">취소/반품/교환</option>
										<option value="etc">기타</option>
									</c:when>
									<c:when test="${inquiry.category == 'delivery'}">
										<option value="">상담유형 선택</option>
									...
									<c:when test="${inquiry.category == 'cancel'}">
										<option value="">상담유형 선택</option>
										<option value="order" >주문/결제</option>
										<option value="delivery" >배송</option>
										<option value="cancel" selected>취소/반품/교환</option>
										<option value="etc">기타</option>
									</c:when>
									...
									<c:otherwise>
										<option value="" selected>상담유형 선택</option>
										<option value="order">주문/결제</option>
										<option value="delivery">배송</option>
										<option value="cancel">취소/반품/교환</option>
										<option value="etc">기타</option>
				...
				<div class="right_box">
					<div>
						<ul>
							<li>*제목</li>
							<li><input type="text" name="title" id="title" value="${inquiry.title}"/></li>
						</ul>
					</div>
					...
					<div>
						<ul>
							<li>*문의내용</li>
							<li class="textbox"><textarea type="text" name="content" id="content">${inquiry.content}</textarea>
							</li>
						</ul>
					</div>
				</div>
