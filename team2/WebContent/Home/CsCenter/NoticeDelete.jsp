...
<body>
	...
	<div class="wrap" id="ori_wrap">
		<div class="top_title">공지사항 삭제</div>

		<form name="Inquiryfrm" method="post" action="${contextPath}/CsCenter/DeleteNotice.do">
			...
			<div class="btn_area">
				<input type="button" value="취소" onclick="location.href='${contextPath}/CsCenter/NoticeList.do'">
