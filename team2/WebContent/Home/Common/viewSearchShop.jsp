...
<script type="text/javascript">
	...
	$(document).on("click",".ct",function(){
		...
		$(".frm").attr("action","../common/viewSearchShop.do").submit();
	});
	...
	function allPageMove(page){
		...
		$("[name=navCategory]").val(navCategory);
		var ord=$("#ord").val();
		location.href="${contextPath}/common/viewSearchShop.do?pageNO="+page+"&ord="+ord+"&navCategory=${navCategory}&shopName=${shopName}&kwd=${kwd}";
	}
</script>
</head>
<body>
