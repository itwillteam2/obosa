...
public class ItemsService {
	...
	//________  food Service _________//
	...
	public List<FoodJoinVO> QnaPagingJoinList(int pageNO, int listSize, int num) {
		List<FoodJoinVO> QnaPagingJoinList = new ArrayList<FoodJoinVO>();
