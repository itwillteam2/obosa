...
<jsp:include page="../inc/top2.jsp"/>
	...
	<div class="content">
		...
		<div class="main">
			<h2>자료실 글쓰기</h2>
			<form class="form2" action="downloadPro.jsp" method="post" enctype="multipart/form-data">
				<table class="table">
					<tr class="name">
						<td>
			...
			<div class="btn">		
				...
				<input type="button" value="목록으로" class="button" id="button" onclick="location.href='../Download.jsp'">
			</div>
			</form>
			<div class="clear"></div>
		</div>
