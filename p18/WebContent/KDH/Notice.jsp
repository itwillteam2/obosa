...
<jsp:include page="inc/top.jsp"/>
	...
	%>
				<tr onclick="location.href='board/content.jsp?num=<%=bean.getNum()%>&pageNum=<%=pageNum%>'">
					<td><%=bean.getNum() %></td>
	...
	%>		
			...
			<div class="btn">		
				<input type="button" value="글쓰기" class="button" id="button" onclick="location.href='board/noticewrite.jsp'">
				...
				<select name="search" class="search1">
