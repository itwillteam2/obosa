...
<jsp:include page="inc/top.jsp"/>
	<div class="img">
		<img alt="문자보내기" src="images/notice/message.jpg"> 
	</div>
	<div class="content">
		<div class="menu">
			<nav>
				...
				<table class="table">
					<tr class="name">
						<td>
							...
							<input type="email" name="name" id="name" value="송정동사무소" readonly/>					
						</td>
					</tr>
					<tr class="passwd">
						<td>
							<label for="passwd">보내는 사람</label>
							<input type="email" name="send" id="send" /> 
						<td>
					</tr>
					<tr class="subject">
						<td>
